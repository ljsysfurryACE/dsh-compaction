...
exports.AgentFrameCompactionEngine = void 0;
const schemastery_1 = __importDefault(require("@deepseek-ai/schemastery"));
const dsh_compaction_1 = require("@deepseek-ai/dsh-compaction");
 ...
 */
class AgentFrameCompactionEngine extends dsh_compaction_1.CompactionEngine {
    static inject = ['llm', 'sessions'];
    static Config = schemastery_1.default.object({
        semantic: schemastery_1.default.boolean().default(true),
        retainRatio: schemastery_1.default.number().min(0.05).max(0.9).default(0.2),
        auto: schemastery_1.default.boolean().default(true),
    });
    config;
...
exports.AgentFrameCompactionEngine = AgentFrameCompactionEngine;
exports.default = AgentFrameCompactionEngine;
